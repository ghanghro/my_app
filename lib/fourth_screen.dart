...
class fourth_screen extends StatefulWidget {
  const fourth_screen({Key? key}) : super(key: key);

  @override
  State<fourth_screen> createState() => _fourth_screen();
}
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 3),
                Image.asset('assets/images/img_1.png',height: 260,fit: BoxFit.cover),
                SizedBox(height: 10),
                Row(
